...
static void gt_FixKeyLengths(CCAlgorithm algorithm, NSMutableData * keyData, NSMutableData * ivData)
{
...
- (NSData*)gt_encryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self gt_CCCryptData:self algorithm:kCCAlgorithmAES128 operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief  利用AES解密据
 *
...
- (NSData*)gt_decryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self gt_CCCryptData:self algorithm:kCCAlgorithmAES128 operation:kCCDecrypt key:key iv:iv];
}
/**
 *  利用3DES加密数据
 *
...
- (NSData*)gt_encryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self gt_CCCryptData:self algorithm:kCCAlgorithm3DES operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief   利用3DES解密数据
 *
...
- (NSData*)gt_decryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self gt_CCCryptData:self algorithm:kCCAlgorithm3DES operation:kCCDecrypt key:key iv:iv];
}
...
- (NSData *)gt_encryptedWithDESUsingKey:(NSString*)key andIV:(NSData*)iv{
    return [self gt_CCCryptData:self algorithm:kCCAlgorithmDES operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief   利用DES解密数据
 *
...
- (NSData *)gt_decryptedWithDESUsingKey:(NSString*)key andIV:(NSData*)iv{
    return [self gt_CCCryptData:self algorithm:kCCAlgorithmDES operation:kCCDecrypt key:key iv:iv];
}
- (NSData *)gt_CCCryptData:(NSData *)data
    ...
    gt_FixKeyLengths(algorithm, keyData,ivData);
