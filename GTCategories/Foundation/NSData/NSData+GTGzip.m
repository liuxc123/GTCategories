...
@implementation NSData (GTGzip)

static void *gt_libzOpen()
{
    static void *libz;
...
{
    if (self.length == 0 || [self gt_isGzippedData])
    {
        return self;
    }

    void *libz = gt_libzOpen();
...
{
    return [self gt_gzippedDataWithCompressionLevel:-1.0f];
}
