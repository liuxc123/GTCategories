...
@implementation NSString (GTMIME)
...
- (NSString *)gt_MIMEType {
    return [[self class] gt_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)gt_MIMETypeForExtension:(NSString *)extension {
    return [[self gt_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
