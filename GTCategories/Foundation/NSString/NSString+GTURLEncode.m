...
@implementation NSString (GTURLEncode)
...
- (NSString *)gt_urlEncode {
    return [self gt_urlEncodeUsingEncoding:NSUTF8StringEncoding];
}
/**
 *  @brief  urlEncode
 *
...
- (NSString *)gt_urlDecode {
    return [self gt_urlDecodeUsingEncoding:NSUTF8StringEncoding];
}
/**
 *  @brief  urlDecode
 *
