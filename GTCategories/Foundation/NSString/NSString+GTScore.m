...
@implementation NSString (GTScore)

- (CGFloat)gt_scoreAgainst:(NSString *)otherString{
    return [self gt_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)gt_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self gt_scoreAgainst:otherString fuzziness:fuzziness options:NSStringGTScoreOptionNone];
}

- (CGFloat)gt_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(NSStringGTScoreOption)options{
    ...
    if(NSStringGTScoreOptionFavorSmallerWords == (options & NSStringGTScoreOptionFavorSmallerWords)){
    ...
    if(NSStringGTScoreOptionReducedLongStringPenalty == (options & NSStringGTScoreOptionReducedLongStringPenalty)){
