//
//  CAAnimation+GTEasingEquations.m
//  FBSnapshotTestCase
//
...
@implementation CAAnimation (GTEasingEquations)
...
+ (void)gt_addAnimationToLayer:(CALayer *)layer
                ...
                easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self gt_transformAnimationWithDuration:duration
...
+ (void)gt_addAnimationToLayer:(CALayer *)layer
                ...
                easingFunction:(CAAnimationEasingFunction)easingFunction
{
    [self gt_addAnimationToLayer:layer
                     withKeyPath:keyPath
                        duration:duration
...
+ (void)gt_addAnimationToLayer:(CALayer *)layer
                ...
                easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self gt_animationWithKeyPath:keyPath
                                                  duration:duration
                                                      from:startValue
                                                        to:endValue
                                            easingFunction:easingFunction];
