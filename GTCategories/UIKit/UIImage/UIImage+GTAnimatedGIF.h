 ...
 */
@interface UIImage (GTAnimatedGIF)

/*
 UIImage *animation = [UIImage gt_animatedImageWithAnimatedGIFData:theData];
 ...
 */
+ (UIImage *)gt_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
 UIImage *image = [UIImagegt_ animatedImageWithAnimatedGIFURL:theURL];
 ...
 */
+ (UIImage *)gt_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
